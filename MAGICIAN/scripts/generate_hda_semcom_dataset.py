#!/usr/bin/env python3
"""Generate HDA semantic communication training data from fresh MAGICIAN runs."""
...
def run_id_for_config(args: argparse.Namespace, config_id: str) -> str:
    ...
    return f"hda_semcom_{config_id}"
...
def existing_raw_trajectory_available(
    ...
    run_id = f"hda_semcom_{damage_config_id}" if record_damage else "magician_observations"
...
def write_incremental_outputs(
    ...
    dataset_summary = {
        "dataset_name": "hda_semcom_dataset",
...
"""Example PyTorch Dataset for HDA semantic communication data."""
