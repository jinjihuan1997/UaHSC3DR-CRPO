...
#ifndef __READER_SCANNETPP_HPP
#define __READER_SCANNETPP_HPP
...
/** Reader for the ScanNet++ dataset. */
class ScanNetppReader : public Reader {
    public:
    /** Construct a ScanNetppReader from a ReaderConfig.
     *
     * \param[in] c The configuration struct to use.
     */
    ScanNetppReader(const ReaderConfig& c);
     ...
     *
     * \return The string `"ScanNetppReader"`.
     */
    ...
    private:
    static constexpr float scannetpp_inverse_scale_ = 1.0f / 1000.0f;
