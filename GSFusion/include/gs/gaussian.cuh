...
class GaussianModel {
    public:
    explicit GaussianModel(const param::OptimizationParameters& params, const std::string& ply_path) : _sh_degree(params.sh_degree), optimParams(params), output_path(ply_path)
    {
    }
    // Copy constructor
